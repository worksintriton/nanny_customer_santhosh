...
import com.triton.nanny.petlover.PetLoverProfileScreenActivity;
...
public class PickUpLocationActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rl_placessearch.setOnClickListener(v -> {
            Intent intent = new Intent(PickUpLocationActivity.this, PlacesSearchActivity.class);
            intent.putExtra("fromactivity",TAG);
            startActivity(intent);
        });
        ...
        btn_setpickuppoint.setOnClickListener(v -> {
            if(CityName != null){
                   Intent intent = new Intent(PickUpLocationActivity.this,AddMyAddressOldUserActivity.class);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(PickUpLocationActivity.this);
    ...
    private void setUpDragListners() {
        ...
        GPSTracker gps = new GPSTracker(PickUpLocationActivity.this);
    ...
    private void getLatandLong(){
        try{
            if (ContextCompat.checkSelfPermission(PickUpLocationActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(PickUpLocationActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(PickUpLocationActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
    ...
    public void showSettingsAlert() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(PickUpLocationActivity.this);
