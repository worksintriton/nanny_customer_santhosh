...
import com.triton.nanny.adapter.PlacesResultsAdapter;
import com.triton.nanny.api.API;
import com.triton.nanny.interfaces.PlacesNameListener;
import com.triton.nanny.responsepojo.AddressResultsResponse;
import com.triton.nanny.responsepojo.CartDetailsResponse;
import com.triton.nanny.responsepojo.PlacesResultsResponse;
import com.triton.nanny.serviceprovider.PickUpLocationSPActivity;
                    ...
                    if(response.body() != null){
                        ...
                        if (resultsBeanList.size() > 0 ) {
                            ...
                            if(fromactivity != null && fromactivity.equalsIgnoreCase("PickUpLocationDenyActivity")){
                                ...
                                i.putExtra("spuserid",spuserid);
                                i.putExtra("selectedServiceTitle",selectedServiceTitle);
                                i.putExtra("serviceamount",serviceamount);
                                i.putExtra("servicetime",servicetime);
                                i.putExtra("SP_ava_Date",SP_ava_Date);
                                i.putExtra("selectedTimeSlot",selectedTimeSlot);
