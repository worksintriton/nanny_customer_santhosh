...
import com.triton.nanny.doctor.DoctorBusinessInfoActivity;
...
public class SetLocationDoctorNewActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    String TAG = "SetLocationDoctorNewActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_setpickuppoint.setOnClickListener(v -> {
            if(CityName != null){
                    Intent intent = new Intent(SetLocationDoctorNewActivity.this, DoctorBusinessInfoActivity.class);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(SetLocationDoctorNewActivity.this);
    ...
    private void setUpDragListners() {
        ...
        GPSTracker gps = new GPSTracker(SetLocationDoctorNewActivity.this);
    ...
    private void getLatandLong(){
        try{
            if (ContextCompat.checkSelfPermission(SetLocationDoctorNewActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(SetLocationDoctorNewActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(SetLocationDoctorNewActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
    ...
    public void showSettingsAlert() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(SetLocationDoctorNewActivity.this);
