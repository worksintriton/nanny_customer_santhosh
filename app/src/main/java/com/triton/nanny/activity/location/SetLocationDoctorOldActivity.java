...
import com.triton.nanny.doctor.EditDoctorBusinessInfoActivity;
...
public class SetLocationDoctorOldActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    String TAG = "SetLocationDoctorOldActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rl_placessearch.setOnClickListener(v -> {
            Intent intent = new Intent(SetLocationDoctorOldActivity.this, PlacesSearchActivity.class);
        ...
        btn_setpickuppoint.setOnClickListener(v -> {
            if(CityName != null){
                    Intent intent = new Intent(SetLocationDoctorOldActivity.this, EditDoctorBusinessInfoActivity.class);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(SetLocationDoctorOldActivity.this);
    ...
    private void setUpDragListners() {
        ...
        GPSTracker gps = new GPSTracker(SetLocationDoctorOldActivity.this);
    ...
    private void getLatandLong(){
        try{
            if (ContextCompat.checkSelfPermission(SetLocationDoctorOldActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(SetLocationDoctorOldActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(SetLocationDoctorOldActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
    ...
    public void showSettingsAlert() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(SetLocationDoctorOldActivity.this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(SetLocationDoctorOldActivity.this, EditDoctorBusinessInfoActivity.class));
        finish();
    }
