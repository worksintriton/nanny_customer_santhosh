...
import com.triton.nanny.serviceprovider.ServiceProviderRegisterFormActivity;
...
public class SetLocationSPNewActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    String TAG = "SetLocationSPNewActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rl_placessearch.setOnClickListener(v -> {
            Intent intent = new Intent(SetLocationSPNewActivity.this, PlacesSearchActivity.class);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(SetLocationSPNewActivity.this);
    ...
    private void setUpDragListners() {
        ...
        GPSTracker gps = new GPSTracker(SetLocationSPNewActivity.this);
    ...
    private void getLatandLong(){
        try{
            if (ContextCompat.checkSelfPermission(SetLocationSPNewActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(SetLocationSPNewActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(SetLocationSPNewActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
    ...
    public void showSettingsAlert() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(SetLocationSPNewActivity.this);
