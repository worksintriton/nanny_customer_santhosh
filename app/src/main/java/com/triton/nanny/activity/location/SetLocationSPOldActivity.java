...
import com.triton.nanny.serviceprovider.ServiceProviderEditFormActivity;
...
public class SetLocationSPOldActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    String TAG = "SetLocationSPOldActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rl_placessearch.setOnClickListener(v -> {
            Intent intent = new Intent(SetLocationSPOldActivity.this, PlacesSearchActivity.class);
        ...
        btn_setpickuppoint.setOnClickListener(v -> {
            if(CityName != null){
                    Intent intent = new Intent(SetLocationSPOldActivity.this, ServiceProviderEditFormActivity.class);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(SetLocationSPOldActivity.this);
    ...
    private void setUpDragListners() {
        ...
        GPSTracker gps = new GPSTracker(SetLocationSPOldActivity.this);
    ...
    private void getLatandLong(){
        try{
            if (ContextCompat.checkSelfPermission(SetLocationSPOldActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(SetLocationSPOldActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(SetLocationSPOldActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
    ...
    public void showSettingsAlert() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(SetLocationSPOldActivity.this);
