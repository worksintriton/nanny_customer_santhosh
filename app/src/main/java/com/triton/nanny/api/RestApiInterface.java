package com.triton.nanny.api;

import com.triton.nanny.requestpojo.*;
import com.triton.nanny.responsepojo.*;
...
public interface RestApiInterface {
    ...
    /*Pet lover dashboard*/
    @POST("userdetails/petlove/mobile/dashboardtest1")
    ...
    @POST("sp_appointments/customer/newapp")
    ...
    @POST("sp_appointments/customer/comapp")
    ...
    @POST("sp_appointments/customer/missapp")
