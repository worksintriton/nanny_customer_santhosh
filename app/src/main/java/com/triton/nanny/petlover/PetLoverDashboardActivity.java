...
import com.triton.nanny.fragmentpetlover.bottommenu.PetCareFragment;
import com.triton.nanny.fragmentpetlover.bottommenu.PetCommunityFragment;
import com.triton.nanny.fragmentpetlover.bottommenu.PetHomeNewFragment;
import com.triton.nanny.fragmentpetlover.bottommenu.PetServicesFragment;
import com.triton.nanny.fragmentpetlover.bottommenu.VendorShopFragment;
        ...
        if(tag != null){
            if(tag.equalsIgnoreCase("1")){
               ...
               img_care.setImageResource(R.drawable.grey_servc);
                ...
                startActivity(new Intent(this,PetLoverProfileScreenActivity.class));
