...
import com.triton.nanny.activity.location.AddMyAddressOldUserActivity;
import com.triton.nanny.activity.location.EditMyAddressActivity;
import com.triton.nanny.activity.location.ManageAddressActivity;
import com.triton.nanny.activity.location.PickUpLocationActivity;
import com.triton.nanny.activity.location.PickUpLocationEditActivity;
import com.triton.nanny.api.APIClient;
import com.triton.nanny.api.RestApiInterface;
import com.triton.nanny.responsepojo.PetListResponse;
import com.triton.nanny.responsepojo.ShippingAddressListingByUserIDResponse;
...
import com.triton.nanny.adapter.ManageAddressListAdapter;
import com.triton.nanny.interfaces.LocationDefaultListener;
import com.triton.nanny.interfaces.LocationDeleteListener;
import com.triton.nanny.requestpojo.LocationDeleteRequest;
import com.triton.nanny.requestpojo.LocationListAddressRequest;
import com.triton.nanny.requestpojo.LocationStatusChangeRequest;
import com.triton.nanny.responsepojo.LocationDeleteResponse;
import com.triton.nanny.responsepojo.LocationListAddressResponse;
import com.triton.nanny.responsepojo.LocationStatusChangeResponse;
...
public class PetLoverProfileScreenActivity extends AppCompatActivity implements View.OnClickListener, LocationDeleteListener, LocationDefaultListener{
...
//    TextView txt_logout;
    ...
    @SuppressLint("NonConstantResourceId")
    @BindView(R.id.img_add_new_address)
    ImageView img_add_new_address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  txt_logout.setOnClickListener(this);
       // ll_add.setOnClickListener(this);
        ...
        img_add_new_address.setOnClickListener(this);
...
//                bottom_navigation_view.getMenu().findItem(R.id.care).setChecked(true);
    ...
    private void gotoMyAddresses() {
        startActivity(new Intent(PetLoverProfileScreenActivity.this, PickUpLocationActivity.class));
