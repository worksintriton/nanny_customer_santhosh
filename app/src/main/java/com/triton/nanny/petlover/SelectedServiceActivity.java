...
import com.triton.nanny.adapter.SelectedServiceProviderAdapter;
import com.triton.nanny.adapter.ViewPagerPetServiceAdapter;
import com.triton.nanny.api.APIClient;
import com.triton.nanny.api.RestApiInterface;
import com.triton.nanny.requestpojo.SPSpecificServiceDetailsRequest;
import com.triton.nanny.responsepojo.SPSpecificServiceDetailsResponse;
import com.triton.nanny.serviceprovider.SPFiltersActivity;
...
//                        txt_totalproviders.setText(serviceProviderList.size()+" Providers");
    ...
    private void setViewListedSP(List<SPSpecificServiceDetailsResponse.DataBean.ServiceProviderBean> serviceProviderList) {
        ...
        SelectedServiceProviderAdapter doctorNewAppointmentAdapter = new SelectedServiceProviderAdapter(getApplicationContext(), serviceProviderList,catid,from,distance,reviewcount,Count_value_start,Count_value_end,flag);
    ...
    public void onBackPressed() {
        ...
        if(from != null && from.equalsIgnoreCase("PetServices")){
            Intent intent = new Intent(getApplicationContext(), PetSubServiceActivity.class);
            startActivity(intent);
            finish();
        }else{
