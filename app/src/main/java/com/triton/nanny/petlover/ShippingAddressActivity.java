...
import com.triton.nanny.activity.location.PickUpLocationAddNewAddressActivity;
...
import com.triton.nanny.doctor.shop.DoctorCartActivity;
import com.triton.nanny.requestpojo.ShippingAddressDeleteRequest;
import com.triton.nanny.requestpojo.ShippingAddressFetchByUserIDRequest;
import com.triton.nanny.responsepojo.CartDetailsResponse;
import com.triton.nanny.responsepojo.CartSuccessResponse;
import com.triton.nanny.responsepojo.ShippingAddressDeleteResponse;
import com.triton.nanny.responsepojo.ShippingAddressFetchByUserIDResponse;
import com.triton.nanny.serviceprovider.ServiceProviderDashboardActivity;
import com.triton.nanny.serviceprovider.shop.SPCartActivity;
...
public class ShippingAddressActivity extends AppCompatActivity implements View.OnClickListener, PaymentResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll_address_list_show.setOnClickListener(this);

        if(fromactivity!=null&&fromactivity.equals("PetServiceAppointment_Doctor_Date_Time_Activity")){
            ...
            ll_create_addreess.setVisibility(View.VISIBLE);
        }
    ...
    private void gotoChooseService() {
        Intent intent = new Intent(ShippingAddressActivity.this, PetloverChooseServiceActivity.class);
        intent.putExtra("data", (Serializable) Data);
        intent.putExtra("product_total",prodouct_total);
        intent.putExtra("shipping_charge",shipping_charge);
        intent.putExtra("discount_price",discount_price);
    ...
    private void gotoSelectCalendar() {
        Intent intent = new Intent(ShippingAddressActivity.this, PetServiceAppointment_Doctor_Date_Time_Activity.class);
        intent.putExtra("data", (Serializable) Data);
        intent.putExtra("product_total",prodouct_total);
        intent.putExtra("shipping_charge",shipping_charge);
        intent.putExtra("discount_price",discount_price);
